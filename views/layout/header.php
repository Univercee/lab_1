        ...
        <div class="container py-2">
            <div>
                <div class="d-flex gap-5 align-items-center">
                    <img src="./inc/images/above-rotator-icon.webp" alt="">
                    <div>
                        <h4>ВКЛЮЧИТЕ ВЫГОДУ НА МАКСИМУМ</h4>
                        <p class="m-0">Еще больше предложений и акций для авторизованных</p>
                    </div>
                </div>
            </div>
        </div>

        <div class="line2 py-2">
            <div class="container d-flex justify-content-between">
                <div>
                <a class="m-0">Москва</a>
                </div>
                <div class="d-flex gap-3">
                    <a class="m-0">8 495 777-777-1</a>
                    <a class="m-0">Магазины</a>
                    <a class="m-0">Доставка и оплата</a>
                    <paclass="m-0">Помощь</a>
                </div>
            </div>
        </div>

        <div class="line3 py-3">
...
<style>
    .line1 {
        background: linear-gradient(to right, #098FEC, #1050DE, #6E1994);
        color: white;
    }
    .line2 {
    ...
    .line3 {
        background: linear-gradient(to right, #000000, #0A3499);;
    }
